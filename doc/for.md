...
### 8.1 Array, slice, string, map, chan
...
`for i in 5` yields the successive indices `0, 1, 2, 3, 4`. It is equivalent to `for i in :5` (see §8.3).
...
A two-value `XGo_Enum` follows the same two-value rules as §8.4:
